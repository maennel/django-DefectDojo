...
class GenericReportCreator(object):
    ...
    _renderer_map = {
        ...
        'text/html': AsciiReportRenderer,
        'text/plain': AsciiReportRenderer,
        'AsciiDoc': AsciiReportRenderer,
        'HTML': AsciiReportRenderer,
    }
    ...
    def populate_base_context(self):
        self.base_context.update({
            ...
            'info': "Generated By %s on %s" % (self.user.get_full_name(),
    ...
    def populate(self, *objs, **context_kwargs):
        ...
        :return: a dict instance representing the populated context
        """
